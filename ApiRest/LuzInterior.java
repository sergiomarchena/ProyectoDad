...
public class LuzInterior {
	...
	public LuzInterior(Integer id, boolean estado, String localizacion_nombre) {
		super();
		this.id = id;
		this.estado = estado;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LuzInterior other = (LuzInterior) obj;
	...
	public String toString() {
		return "Luz_interior [id=" + id + ", estado=" + estado + ", localizacion_nombre=" + localizacion_nombre + "]";
	}
	}