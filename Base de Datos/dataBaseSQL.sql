...
CREATE TABLE `actuadores` (
  ...
  `sentido` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `sensores` (
  ...
  KEY `nombre_localizacion_sensores_idx` (`localizacion_nombre`),
  CONSTRAINT `nombre_localizacion_sensores` FOREIGN KEY (`localizacion_nombre`) REFERENCES `localizaciones` (`nombre`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sensores` VALUES (1,'2014-12-01 00:00:00',100,'penya','Cocina'),(7,'2014-12-01 00:00:00',89,'delos','Habitacion'),(7,'2018-04-29 14:11:44',89,'delos','Habitacion'),(7,'2018-04-29 14:11:49',89,'delos','Habitacion'),(7,'2018-04-29 14:11:54',89,'delos','Habitacion'),(7,'2018-04-29 14:12:00',89,'delos','Habitacion'),(7,'2018-04-29 14:12:05',89,'delos','Habitacion'),(7,'2018-04-29 14:12:10',89,'delos','Habitacion'),(7,'2018-04-29 14:12:16',89,'delos','Habitacion'),(7,'2018-04-29 14:12:21',89,'delos','Habitacion'),(7,'2018-04-29 14:12:27',89,'delos','Habitacion'),(7,'2018-04-29 14:14:14',89,'delos','Habitacion'),(7,'2018-04-29 14:18:05',89,'delos','Habitacion'),(7,'2018-04-29 14:18:14',89,'delos','Habitacion'),(7,'2018-04-29 14:19:18',89,'delos','Habitacion'),(7,'2018-04-29 14:19:29',89,'delos','Habitacion'),(7,'2018-04-29 14:20:19',89,'delos','Habitacion'),(7,'2018-04-29 14:21:10',89,'delos','Habitacion'),(7,'2018-04-29 14:22:00',89,'delos','Habitacion'),(7,'2018-04-29 14:27:40',89,'delos','Habitacion'),(7,'2018-04-29 14:27:54',89,'delos','Habitacion'),(7,'2018-04-29 14:28:44',89,'delos','Habitacion'),(7,'2018-04-29 14:29:35',89,'delos','Habitacion'),(7,'2018-04-29 14:48:15',89,'delos','Habitacion'),(7,'2018-04-29 14:48:37',89,'delos','Habitacion'),(7,'2018-04-29 14:49:27',89,'delos','Habitacion');
...
-- Dump completed on 2018-04-29 14:53:09
